...
export default function ModuleAccessControl() {
  return (
    <div>
      <div className="bg-white border-b border-slate-200 sticky top-0 z-30">
        <div className="px-8 py-6">
          <h1 className="text-3xl font-bold text-slate-900">Module Access Control</h1>
          <p className="text-slate-600 mt-1">Control which roles can access which modules</p>
        </div>
      </div>
