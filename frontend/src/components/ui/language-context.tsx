...
const translations: Record<string, { en: string; tl: string; bis: string }> = {
  ...
  spAppTypeRenewal: { en: "Renewal Solo Parent ID", tl: "Renewal Solo Parent ID", bis: "Renewal Solo Parent ID" },
  spAppTypeLoss: { en: "Replacement / Lost Solo Parent ID", tl: "Replacement / Nawalang Solo Parent ID", bis: "Replacement / Nawala nga Solo Parent ID" },
  ...
  spLabelExistingVerified: { en: "Existing record verified", tl: "Na-verify ang umiiral na rekord", bis: "Na-verify ang daang rekord" },
