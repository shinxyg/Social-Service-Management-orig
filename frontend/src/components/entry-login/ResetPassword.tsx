        ...
        <div className="w-full max-w-md p-6 sm:p-8 rounded-2xl bg-white shadow-xl border border-slate-200">
          {success ? (
            ...
            <>
              ...
              {error && (
                <div className="p-3 mb-4 text-xs text-red-600 bg-red-50 rounded-lg border border-red-200 text-center">
                  {error}
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-left">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2.5 text-xs md:text-sm bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:bg-white text-slate-700"
                      required
                    />
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-2.5 px-4 bg-[#2563EB] hover:bg-[#1D4ED8] active:bg-[#1E40AF] disabled:opacity-60 text-white font-semibold text-xs md:text-sm rounded-lg shadow-sm transition-colors cursor-pointer mt-2"
                >
