...
export default function ApplyAICS({ initialType, initialTypeKey, onBack: _onBack }: ApplyAICSProps) {
  ...
  const [hospitalBillEstimate, _setHospitalBillEstimate] = useState("")
  const [_checklistPriorAid, setChecklistPriorAid] = useState<"yes" | "no">("no")
  const [priorAidOffice, _setPriorAidOffice] = useState("")
  const [priorAidType, _setPriorAidType] = useState("")
