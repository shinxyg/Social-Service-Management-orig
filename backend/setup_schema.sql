...
-- 27. Solo Parent and Child Welfare Applications Table
...
CREATE INDEX IF NOT EXISTS idx_spcw_ref ON solo_parent_child_welfare_applications(reference_number);
CREATE INDEX IF NOT EXISTS idx_spcw_user ON solo_parent_child_welfare_applications(user_id);
...
-- 28. Seed Admin User Account (Email: admin@quezoncity.gov.ph | Password: Admin123!)
INSERT INTO users (
