  ...
  try {
    ...
    const mapped = result.rows.map((row) => {
      ...
      return {
        ...
        employmentStatus: extra.employmentStatus || extra.employment_status || '',
        occupation: extra.occupation || '',
        sourceOfIncome: extra.sourceOfIncome || extra.source_of_income || '',
        educationalAttainment: extra.educationalAttainment || '',
        otherEducationInfo: extra.otherEducationInfo || '',
        isLivingAlone: extra.isLivingAlone !== undefined ? extra.isLivingAlone : false,
        extra_data: extra,
        documents: cleanDocs,
